...
function Center() {
    ...
    return (
        <div className="flex-grow h-screen overflow-scroll text-white scrollbar-hide">
            ...
            <section className={`flex items-end p-8 space-x-7 bg-gradient-to-b to-black ${color} h-80`}>
                <img className="shadow-2xl w-44 h-44" src={playlist?.images?.[0]?.url} alt="" />
                <div>
                    <p>Playlist</p>
